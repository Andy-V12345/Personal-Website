...
function SkillBox({children, title, isLarge}) {
    if (isLarge) {
        return (
            <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{type: "spring", delay: 0, duration: 0.4}} className='skillbox-large w-3/5 py-10 px-10 space-y-5'>
